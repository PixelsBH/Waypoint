...
| LLM provider | **Google Gemini 3.5 Flash** (primary), Groq as automatic fallback | Free tier, fast, good structured-output adherence via `@ai-sdk/google`. Model choice doesn't affect grading — pick for reliability, not brand. |
